...
//This disables the slide so you can't slide the menu to open it.
...
*/
	// if (OS_ANDROID) {
		// //If landscape then swap height with width since it gives us the wrong one.
		// if(Ti.Gesture.orientation == Ti.UI.LANDSCAPE_LEFT || Ti.Gesture.orientation == Ti.UI.LANDSCAPE_RIGHT){
			// screenWidth = Ti.Platform.displayCaps.getPlatformHeight();
			// screenHeight = Ti.Platform.displayCaps.getPlatformWidth();
		// }
	// }
