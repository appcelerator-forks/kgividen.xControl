...
ti clean
ti build -p android -T dist-playstore -K /Users/kgividen/.android/key/$1Keystore -P $2 -L xControl -O $XCONTROL_PATH/delivery/
mv $XCONTROL_PATH/delivery/$1.apk $XCONTROL_PATH/delivery/$1Unsigned.apk
jarsigner -verbose -storepass $2 -sigalg MD5withRSA -digestalg SHA1 -keystore ~/.android/key/$1Keystore $XCONTROL_PATH/delivery/$1Unsigned.apk $1
